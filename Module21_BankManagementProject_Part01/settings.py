"""
Django settings for Module21_BankManagementProject_Part01 project.
...
ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ['https://mamar-bank-ysrx.onrender.com','https://*.127.0.0.1']
...
ROOT_URLCONF = 'Module21_BankManagementProject_Part01.urls'
...
WSGI_APPLICATION = 'Module21_BankManagementProject_Part01.wsgi.application'

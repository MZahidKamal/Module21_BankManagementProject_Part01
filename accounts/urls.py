...
from .views import UserRegistrationForm_View, UserLoginForm_View, UserLogoutForm_View, UserProfileUpdateForm_View, UserPasswordUpdateForm_View
...
urlpatterns = [
    ...
    path('change_password/', UserPasswordUpdateForm_View.as_view(), name='change_password'),
]
